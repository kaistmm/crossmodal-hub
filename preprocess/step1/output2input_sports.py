...
def parse_args():
    ...
    parser.add_argument("--input_file", type=str,
                        default="exp_bear1/global2/qwen7b/step1/sports/av/sports_case_1.json")
    parser.add_argument("--output_path", type=str,
                        default="json_files/step2/sports.json")
...
v_file=input_file.replace("/av/","/a/")
...
for item in tqdm(load_jsonl(input_file)):
    ...
    entry = [
        ...
        },
        {
            ...
            "correct_corrupt_word_prob": item["a_prob"], #correct output에서 corrupt token의 확률
            "corrupt_correct_word_prob": v_dict[item["video"]][0]["av_prob"], #corrupt output에서 correct token의 확률
            "corrupt_corrupt_word_prob": v_dict[item["video"]][0]["a_prob"], #corrupt output에서 corrupt token의 확률
